...
// stress[0][0] = phi*young*(1/((1+poiss)*(1-2*poiss)))*((1-poiss)*strain[0][0]+poiss*strain[1][1]);
// stress[1][1] = phi*young*(1/((1+poiss)*(1-2*poiss)))*((1-poiss)*strain[1][1]+poiss*strain[0][0]);
// stress[2][2] = phi*young*(1/((1+poiss)*(1-2*poiss)))*poiss*(strain[0][0]+strain[1][1]);
// stress[0][1] = phi*young*(1/(2*(1+poiss)))*strain[0][1];
