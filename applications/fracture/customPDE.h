...
// Function to set the nucleation probability (in nucleation.h)
 ...
 double dx=userInputs.domain_size[0]/((double) userInputs.subdivisions[0])/std::pow(2.0,userInputs.refine_factor);
        ...
        double ell = userInputs.get_model_constant_double("ell");
        double Gc0 = userInputs.get_model_constant_double("Gc0");

        const static unsigned int CIJ_tensor_size =2*dim-1+dim/3;
        dealii::Tensor<2,CIJ_tensor_size> CIJ_base = userInputs.get_model_constant_elasticity_tensor("CIJ_base");

        double KI_nom = userInputs.get_model_constant_double("KI_nom");
        double vel_nom = userInputs.get_model_constant_double("vel_nom");
