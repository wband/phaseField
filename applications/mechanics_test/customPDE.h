...
{
    using MatrixFreePDE<dim,degree>::currentTime;
public:
	...
	double KI = userInputs.get_model_constant_double("KI");
	double mubar = userInputs.get_model_constant_double("mubar");
	double vel = userInputs.get_model_constant_double("vel");
