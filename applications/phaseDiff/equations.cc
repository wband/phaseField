...
void variableAttributeLoader::loadVariableAttributes(){
    ...
    set_dependencies_gradient_term_RHS(0, "grad(c), phi1");
    set_dependencies_value_term_LHS(0, "");
    set_dependencies_gradient_term_LHS(0, "grad(change(c)), phi1");
...
scalarvalueType phi1 = variable_list.get_scalar_value(1);
variable_list.set_scalar_gradient_term_RHS(0,-cx*phi1);
}
...
variable_list.set_scalar_gradient_term_LHS(0,cx*phi1);
