...
public:
    ...
    void setInitialCondition(const dealii::Point<dim> &p, const unsigned int index, double & scalar_IC, dealii::Vector<double> & vector_IC, double* data=NULL);
	...
	// ================================================================
        double Emin = userInputs.get_model_constant_double("Emin");
        double Esigma = userInputs.get_model_constant_double("Esigma");
        double cwidth = userInputs.get_model_constant_double("crackwidth");
        double clength = userInputs.get_model_constant_double("cracklength");
        bool stepped_strain = userInputs.get_model_constant_bool("stepped_strain");
        double u_init = userInputs.get_model_constant_double("u_init");
