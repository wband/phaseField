...
private:
  ...
  number n_init =
    this->get_user_inputs().get_user_constants().get_model_constant_double("n_init"); 
  number c_init =
    this->get_user_inputs().get_user_constants().get_model_constant_double("c_init"); 
  number j_rxn =
    this->get_user_inputs().get_user_constants().get_model_constant_double("j_rxn"); 
  number McV =
    this->get_user_inputs().get_user_constants().get_model_constant_double("McV"); 
  number channel_depth =
    this->get_user_inputs().get_user_constants().get_model_constant_double("channel_depth"); 
